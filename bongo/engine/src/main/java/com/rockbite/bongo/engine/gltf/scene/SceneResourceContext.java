...
public class SceneResourceContext {
    ...
    private final IntMap<Texture> loadedTextures = new IntMap<>();
    private final ObjectMap<TextureSamplerRef, Texture> hashedTextures = new ObjectMap<>();
    private final IntMap<SceneMaterial> sceneMaterials = new IntMap<>();
    private final IntMap<SceneMesh> sceneMeshes = new IntMap<>();
    private final IntMap<ByteBuffer> buffers = new IntMap<>();
    private final IntMap<SceneSkin> sceneSkins = new IntMap<>();
    private final IntMap<Array<SceneAnimationData>> sceneAnimationDatas = new IntMap<>();
