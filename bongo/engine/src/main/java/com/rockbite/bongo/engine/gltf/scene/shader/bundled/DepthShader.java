...
public class DepthShader extends BaseSceneShader {
    ...
    private int u_bones;
    public DepthShader(FileHandle vertexSource, FileHandle fragmentSource, SceneRenderable sceneRenderable, World world) {
