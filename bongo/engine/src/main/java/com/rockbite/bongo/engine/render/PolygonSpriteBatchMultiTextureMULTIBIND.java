...
public class PolygonSpriteBatchMultiTextureMULTIBIND implements PolyBatchWithEncodingOverride {
    ...
    private final float[] customInfoArray = new float[CUSTOM_INFO_COMPONENTS];
...
//				System.out.println();
//			}
            vertices[vertexOffset + (rootOffset)] = polygonVertices[i]; //x
    ...
    public void draw(Texture texture, float[] spriteVertices, int offset, int count) {
        ...
        int calculatedSize = count / 20 * SPRITE_SIZE;
        ...
        for (int i = 0; i < count; i += 5) { //copy and fake
            ...
            vertices[vertexOffset + (rootOffset)] = spriteVertices[i]; //x
