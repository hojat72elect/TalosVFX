...
package com.rockbite.bongo.engine.camera;
...
public class BongoCameraController extends GestureDetector {
    ...
    protected BongoCameraController(final CameraGestureListener gestureListener, final Camera camera) {
    ...
    public BongoCameraController(final Camera camera) {
