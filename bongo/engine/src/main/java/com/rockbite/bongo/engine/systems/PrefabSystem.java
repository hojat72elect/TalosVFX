...
public class PrefabSystem extends BaseSystem {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PrefabSystem.class);
    ...
    private final ObjectMap<String, PrefabConfig> prefabIdentifierMap = new ObjectMap<>();

    private final Array<String> prefabFiles = new Array<>();

    private final PrefabReader prefabReader = new PrefabReader();
