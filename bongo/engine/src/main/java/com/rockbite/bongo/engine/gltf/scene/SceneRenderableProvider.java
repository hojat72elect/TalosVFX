...
public class SceneRenderableProvider {
    ...
    private final Pool<SceneRenderable> sceneRenderablePool = new Pool<SceneRenderable>() {
        @Override
    ...
    private final Comparator<? super SceneRenderable> shaderSorter = new Comparator<SceneRenderable>() {
        @Override
