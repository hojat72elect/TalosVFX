...
public class UnlitShader extends BaseSceneShader {
    ...
    public UnlitShader(FileHandle vertexSource, FileHandle fragmentSource, SceneRenderable sceneRenderable, World world) {
