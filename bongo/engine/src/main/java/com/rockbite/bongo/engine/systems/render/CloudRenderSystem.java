...
public class CloudRenderSystem extends RenderPassSystem {
    ...
    private final ShaderProcessingSystem.ProgramExtraction normalBlurPassExtraction = new ShaderProcessingSystem.ProgramExtraction("CloudNormalBlurPass");
    private final ShaderProcessingSystem.ProgramExtraction depthNoisePassExtraction = new ShaderProcessingSystem.ProgramExtraction("CloudDepthNoisePass");
    private final ShaderProcessingSystem.ProgramExtraction depthBlurPassExtraction = new ShaderProcessingSystem.ProgramExtraction("CloudDepthBlurPass");
    private final ShaderProcessingSystem.ProgramExtraction compositeProgramExtraction = new ShaderProcessingSystem.ProgramExtraction("CloudComposite");
