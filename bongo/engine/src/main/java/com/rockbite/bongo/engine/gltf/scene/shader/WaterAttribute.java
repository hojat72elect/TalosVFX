...
public class WaterAttribute extends Attribute {
    ...
    @Getter
    private final ShaderWaveInfo[] waves;
    @Getter
    private final float[] foamFalloff = new float[]{3};
    @Getter
    private final float[] foamScrolling = new float[]{-0.988f};
    @Getter
    private final float[] foamScrolling2 = new float[]{-1.578f};
