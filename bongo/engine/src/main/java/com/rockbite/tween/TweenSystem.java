...
import com.rockbite.tween.controllers.Vector2TweenController;
...
public class TweenSystem extends BaseSystem {
    ...
    private static final Vector3 dummy = new Vector3();
    private TweenGroup currentGroup = DEFAULT;
    private final TweenControllerMap tweenControllerMap = new TweenControllerMap();
    private final TweenPool tweenPool = new TweenPool();
    private final Array<Tween> runningTweens = new Array<>();
    private final Array<Tween> completedTweens = new Array<>();
    private final Array<Tween> delayedAddTweens = new Array<>();
...
//				completedTweens.add(runningTween);
    ...
    static class TweenPoolMap {
        private final ObjectMap<Class, PoolWithBookkeeping<Tween<?>>> pools = new ObjectMap<>();
    ...
    class TweenControllerMap {
        private final ObjectMap<Class, TweenController> controllers = new ObjectMap<>();
        private final ObjectMap<Class, TweenMask[]> tweenMasks = new ObjectMap<>();
