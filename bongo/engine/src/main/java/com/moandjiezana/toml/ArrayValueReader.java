...
class ArrayValueReader implements ValueReader {
    ...
    private boolean isHomogenousArray(Object o, List<?> values) {
        return values.isEmpty() || ClassReflection.isAssignableFrom(values.get(0).getClass(), o.getClass()) || ClassReflection.isAssignableFrom(o.getClass(), values.get(0).getClass());
    }
}
