...
public class TomlWriter {
     ...
     */
    public TomlWriter() {
        this(0, 0, 0, new FaketimeZone(), false);
    }

    private TomlWriter(int keyIndentation, int tableIndentation, int arrayDelimiterPadding, FaketimeZone timeZone, boolean showFractionalSeconds) {
    ...
    public static class Builder {
        ...
        private FaketimeZone timeZone = new FaketimeZone();
        ...
        public Builder timeZone(FaketimeZone timeZone) {
