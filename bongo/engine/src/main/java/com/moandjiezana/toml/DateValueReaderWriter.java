...
class DateValueReaderWriter implements ValueReader, ValueWriter {
    ...
    public Object read(String original, AtomicInteger index, Context context) {
        ...
        try {
            FakeDateFormatter dateFormat = new FakeDateFormatter(format);
    ...
    public void write(Object value, WriterContext context) {
        FakeDateFormatter formatter = getFormatter(context.getDatePolicy());
    ...
    private FakeDateFormatter getFormatter(DatePolicy datePolicy) {
        ...
        FakeDateFormatter formatter = new FakeDateFormatter(format);
    ...
    private static class DateConverterJdk6 extends DateValueReaderWriter {
        @Override
        public void write(Object value, WriterContext context) {
            FakeDateFormatter formatter = super.getFormatter(context.getDatePolicy());
