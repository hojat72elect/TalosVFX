...
public class IMGUIPlatformImpl implements IMGUIPlatform {
    ...
    private Bag<Component> singletons;
    private final ObjectMap<ComponentExposeFlavour, ImguiMapper> mappers = new ObjectMap<>();
    private final ObjectMap<Class, ImguiMapper> objectMappers = new ObjectMap<>();
    private final Bag<Component> fillBag = new Bag<Component>();
