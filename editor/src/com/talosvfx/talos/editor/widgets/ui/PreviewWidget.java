...
public abstract class PreviewWidget extends ViewportWidget {
    ...
    private final String countStr = "Particles: ";
    private final String trisCountStr = "Triangles: ";
    private final String nodeCallsStr = "Node Calls: ";
    private final String gpuTimeStr = "GPU: ";
    private final String cpuTimeStr = "CPU: ";
    private final String msStr = "ms";
    private final Label countLbl;
    private final Label trisCountLbl;
    private final Label nodeCallsLbl;
    private final Label gpuTimeLbl;
    private final Label cpuTimeLbl;
...
//						TalosMain.Instance().ProjectController().setDirty();
    ...
    private boolean vfxNeedsUpdate() {
        ...
        return effectInstance.getEmitters().size != vfxProjectData.getEditorState().activeWrappers.size;
    }
