...
public abstract class ViewportWidget extends Table {
    ...
    private final Array<EventListener> storedListeners = new Array<>();
    private final Vector2 cameraPosTmp = new Vector2();
    private final Vector2 mousePosTmp = new Vector2();
    ...
    protected InputListener addGizmoListener() {
        InputListener gizmoListener = new InputListener() {
            ...
            final boolean dragOnFirstTime = true;
    ...
    private boolean canTouchGizmo(Gizmo testGizmo) {
        ...
        return !testGizmo.getGameObject().isEditorTransformLocked();
    }
