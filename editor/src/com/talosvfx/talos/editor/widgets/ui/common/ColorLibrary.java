...
public class ColorLibrary {
    ...
    private final IntMap<Drawable> colorDrawableCache = new IntMap<>();
    private final IntMap<Drawable> drawableCache = new IntMap<>();
    private final IntMap<ClippedNinePatchDrawable> clippedPatchCache = new IntMap<>();
