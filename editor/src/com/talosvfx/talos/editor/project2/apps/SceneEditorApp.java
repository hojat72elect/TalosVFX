...
@SingletonApp
public class SceneEditorApp extends AppManager.BaseApp<SavableContainer> implements GameAsset.GameAssetUpdateListener, ContainerOfPrefs<ViewportPreferences>, Observer {
