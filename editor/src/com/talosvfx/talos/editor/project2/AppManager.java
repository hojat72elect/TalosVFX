...
import com.talosvfx.talos.editor.project2.apps.EmitterTimelineApp;
...
public class AppManager extends InputAdapter implements Observer {
    ...
    private final ObjectMap<GameAsset<?>, Array<? extends BaseApp<?>>> baseAppsOpenForGameAsset = new ObjectMap<>();
    private final AppRegistry appRegistry = new AppRegistry();
    private Vector2 vector2 = new Vector2();
    private final Array<LayoutContent> out = new Array<>();
    ...
    public <T, U extends BaseApp<T>> boolean canOpenInApp(GameAsset<T> asset, Class<U> app) {
        ...
        if (asset.equals(singletonAsset)) {
            return app.equals(ProjectExplorerApp.class);
    ...
    private boolean canTabTypes(GameAssetType gameAssetType, GameAssetType appToCreateType) {
        ...
        return gameAssetType == GameAssetType.PREFAB && appToCreateType == GameAssetType.SCENE;
    }
    ...
    private static class AppRegistry {
        ...
        private final ObjectMap<String, Class<? extends BaseApp<?>>> simpleNameMap = new ObjectMap<>();
        private final ObjectMap<GameAssetType, Array<Class<? extends BaseApp<?>>>> gameAssetTypeToAppsMap = new ObjectMap<>();
