...
class Item extends Widget implements ActorCloneable<Item> {
    ...
    private final Image brokenStatus;
    private GameObject basicGameObject;

    private boolean selected;
    private boolean mouseover;

    private final float padTop = 5;
    private final float padTopSmall = 2;
    private final float padTopBig = 7;
    private final float padLeft = 5;
    private final float padLeftSmall = 2;
    private final float padLeftBig = 7;
    private final float padBottom = 5;
    private final float padBottomSmall = 2;
    private final float padBottomBig = 7;
    private final float padRight = 5;
    private final float padRightSmall = 2;
    private final float padRightBig = 7;
    private final float space = 5;
    private final float spaceSmall = 2;
    private final float spaceBig = 7;
