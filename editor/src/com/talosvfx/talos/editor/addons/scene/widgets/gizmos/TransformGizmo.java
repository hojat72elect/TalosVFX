...
public class TransformGizmo extends Gizmo {
    ...
    private final BoundingBox selectionBounds = new BoundingBox();
    ...
    public void draw(Batch batch, float parentAlpha) {
        if (gameObject.hasComponent(TransformComponent.class)) {
            ...
            TransformComponent.localToWorld(gameObject, tmp.set(0, 0));
    ...
    public void touchDragged(float x, float y) {
        ...
        TransformComponent transform = gameObject.getComponent(TransformComponent.class);
        vec1.set(0, 0);
        TransformComponent.localToWorld(gameObject.parent, vec1);
        vec1.add(tmp); // change diff
        TransformComponent.worldToLocal(gameObject.parent, vec1);
        //vec1 is diff
