 ...
 */
public class PolygonSpriteBatchMultiTexture implements PolyBatchWithEncodingOverride {
     ...
     *
     * @see #PolygonSpriteBatchMultiTexture(int, int, ShaderProgram)
     */
    public PolygonSpriteBatchMultiTexture() {
        this(2000, null);
    }
     ...
     * @see #PolygonSpriteBatchMultiTexture(int, int, ShaderProgram)
     */
    public PolygonSpriteBatchMultiTexture(int size) {
     ...
     * @see #PolygonSpriteBatchMultiTexture(int, int, ShaderProgram)
     */
    public PolygonSpriteBatchMultiTexture(int size, ShaderProgram defaultShader) {
     ...
     */
    public PolygonSpriteBatchMultiTexture(int maxVertices, int maxTriangles, ShaderProgram defaultShader) {
    ...
    public void draw(Texture texture, float[] polygonVertices, int verticesOffset, int verticesCount, short[] polygonTriangles,
        ...
        if (customColourEncoding) {
            for (int i = vertexIndex; i < vertexIndex + verticesCount; i += VERTEX_SIZE) {
                vertices[i + 2] = customColourBitsToBeEncoded;
            }
        }
    ...
    public void draw(Texture texture, float[] spriteVertices, int offset, int count) {
        ...
        if (customColourEncoding) {
            for (int i = vertexIndex; i < vertexIndex + count; i += VERTEX_SIZE) {
                vertices[i + 2] = customColourBitsToBeEncoded;
            }
        }
    ...
    @Override
    public void sampleEmissive(boolean sampleEmissive) {
        this.sampleEmissive = sampleEmissive;
    }

    @Override
    public boolean isSamplingEmissive() {
        return sampleEmissive;
    }
