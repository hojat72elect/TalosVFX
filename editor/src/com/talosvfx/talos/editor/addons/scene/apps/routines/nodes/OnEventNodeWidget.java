...
public class OnEventNodeWidget extends RoutineNodeWidget {
    ...
    private void fillFields() {
        ...
        for (int i = 0; i < propertyWrappers.size; i++) {
            ...
            addConnection(widget, propertyWrapper.propertyName, false);
            ...
            widget.addListener(new CustomVarWidget.CustomVarWidgetChangeListener() {
                ...
                public void nameChanged(CustomVarChangeEvent event, Actor actor, String oldName, String newName, boolean isFastChange) {
                    NodeBoard.NodeConnection connection = nodeBoard.findConnection(OnEventNodeWidget.this, true, oldName);
                    if (connection != null) {
                        // update wires
