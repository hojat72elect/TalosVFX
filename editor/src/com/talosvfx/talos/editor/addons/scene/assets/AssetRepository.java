...
//				loadChangesFromScripts(AssetRepository.this::fileVisit);
    ...
    private void checkAllGameAssetCreation() { //raws
        ...
        checkGameAssetCreation(GameAssetType.SHADER);
    ...
    public void exportToFile(AssetRepositoryCatalogueExportOptions settings, boolean isOptimized) { //todo
        ...
        if (settings.isForceExportAll()) {
            ...
            exportGameAsset(settings, GameAssetType.SHADER, forceAllPredicate, gameAssetsToExport);
        ...
        try {
            switch (assetTypeFromExtension) {
                ...
                case SHADER:
                    ...
                    ShaderStageData shaderStageData = json.fromJson(ShaderStageData.class, TempHackUtil.hackIt(value.handle.readString()));

                    shaderStageData.setName(value.handle.nameWithoutExtension());

                    ((GameAsset<ShaderStageData>) gameAssetOut).setResourcePayload(shaderStageData);
