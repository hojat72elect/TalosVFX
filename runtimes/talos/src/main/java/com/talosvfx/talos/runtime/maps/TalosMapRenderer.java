...
public class TalosMapRenderer {
    ...
    private final ObjectMap<MapType, RenderFunction> renderModes = new ObjectMap<>();
        ...
        for (TalosLayer layer : layers) {
            ...
            switch (type) {
                case STATIC:
                    ...
                    int sX = MathUtils.floor(startX / tileSizeX) * tileSizeX;
                    int sY = MathUtils.floor(startY / tileSizeY) * tileSizeY;
